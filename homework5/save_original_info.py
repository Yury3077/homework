...
def save_decorator(original_func: Callable) -> Callable:
    """
    Decorator with parameter, save __doc__ and __name__ of
    original func and save this func too
    """

    def wraps_deco(wrapper):
...
# if __name__ == "__main__":  # не удалял, так как было в исходном коде
